...
async def cmd_start(message: Message, state: FSMContext):
    ...
    if not user_data:
        await create_user(user_id=user.id, username=user.username, first_name=user.first_name, language="en")
...
async def extra_afk_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_afk_callback: {e}", exc_info=True)
...
async def extra_quotly_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_quotly_callback: {e}", exc_info=True)
...
async def extra_stickers_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_stickers_callback: {e}", exc_info=True)
...
async def extra_memefi_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_memefi_callback: {e}", exc_info=True)
...
async def extra_welcome_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_welcome_callback: {e}", exc_info=True)
...
async def extra_tagall_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_tagall_callback: {e}", exc_info=True)
...
async def extra_locks_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_locks_callback: {e}", exc_info=True)
...
async def extra_warns_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_warns_callback: {e}", exc_info=True)
...
async def extra_ban_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_ban_callback: {e}", exc_info=True)
...
async def extra_mute_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_mute_callback: {e}", exc_info=True)
...
async def extra_filters_callback(callback: CallbackQuery):
    ...
    try:
        ...
        logger.error(f"Error in extra_filters_callback: {e}", exc_info=True)
